...
var taskInput = document.getElementById("add-body__input-id");//Add a new task.
var addButton=document.getElementsByTagName("button")[0];//first button
var incompleteTaskHolder = document.getElementById("to-do__task-list");//ul of #incompleteTasks
var completedTasksHolder = document.getElementById("completed__task-list");//completed-tasks
...
var editTask=function(){
    ...
    var containsClass = listItem.classList.contains("task-list__task_edit-mode");
    ...
    listItem.classList.toggle("task-list__task_edit-mode");
};
